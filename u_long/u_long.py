...
def generate_blobs(nside, nexp=1, exptime=30., u_exptime=60., filter1s=['u', 'u', 'g', 'r', 'i', 'z', 'y'],
    ...
    for filtername, filtername2 in zip(filter1s, filter2s):
        ...
        if filtername2 is not None:
            if filtername2 == 'u':
                ...
                pair_time = exptime
            detailer_list.append(detailers.Take_as_pairs_detailer(filtername=filtername2, exptime=pair_time))
