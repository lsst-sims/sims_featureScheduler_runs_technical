    ...
    for filtername, filtername2 in zip(filter1s, filter2s):
        ...
        if filtername2 is not None:
            ...
            bfs.append((bf.Footprint_rolling_basis_function(filtername=filtername,
                                                            ...
                                                            day_offset=day_offset, max_season=max_season), footprint_weight/2.))
...
if __name__ == "__main__":
    ...
    fileroot = 'rollingsw_'+'mod%i_sdf_%.2f_' % (mod_year, scale_down_factor)
    file_end = 'v1.5_'
    ...
    # Let's try setting the weights the same
    all_rolling_sum = all_footprints_sum
