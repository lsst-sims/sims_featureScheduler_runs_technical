...
sched_logger_sh = logging.StreamHandler()
sched_logger_sh.setLevel(logging.DEBUG)
sched_logger.addHandler(sched_logger_sh)
...
def run_sched(surveys, survey_length=365.25, nside=32, fileroot='baseline_cloud28_', verbose=False,
