...
def gen_greedy_surveys(nside=32, nexp=1, exptime=30., filters=['r', 'i', 'z', 'y'],
                       ...
                       stayfilter_weight=3., night_gap_weight=3., footprints=None, gap_fp=None):
    """
    ...
    for filtername in filters:
        ...
        bfs.append((bf.Avoid_long_gaps_basis_function(nside=nside, footprint=gap_fp), night_gap_weight))
...
def generate_blobs(nside, nexp=1, exptime=30., filter1s=['u', 'u', 'g', 'r', 'i', 'z', 'y'],
                   ...
                   stayfilter_weight=3., template_weight=12., night_gap_weight=3., gap_fp=None,
                   footprints=None):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gap_weight", type=float, default=3)
    ...
    fileroot = 'night_gap_%.1f_' % gap_weight 
    file_end = 'v1.6_'
    ...
    gap_fp = footprints_hp['r']*0
    gap_fp[np.where(footprints_hp['r'] == 1)] = 1
