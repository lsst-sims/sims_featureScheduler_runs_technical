...
class Geo_feasibility_basis_function(basis_functions.Base_basis_function):
    def __init__(self, ra, dec):
        super(Geo_feasibility_basis_function, self).__init__()
        self.ra = ra
        self.dec = dec
...
def dd_bfs(RA, dec, survey_name, ha_limits, frac_total=0.0185/2., aggressive_frac=0.011/2.,
    ...
    bfs.append(Geo_feasibility_basis_function(ra=RA, dec=dec))
