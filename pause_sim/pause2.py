...
def run_sched(surveys, survey_length=None, nside=32, fileroot='baseline_', verbose=False,
              extra_info=None, illum_limit=40., sl1=730, sl2=2922, pause_length=183, delete_past=True):
    ...
    observatory, scheduler, observations2 = sim_runner(observatory, scheduler,
                                                       survey_length=sl2,
                                                       filename=None,
                                                       delete_past=True, n_visit_limit=n_visit_limit,
                                                       verbose=verbose, extra_info=extra_info,
...
class Step_line_combo(Base_pixel_evolution):
    ...
    def __init__(self, period=365.25, rise=1., t_start=0., t_break=0., t_start2=0.):
        self.period = period
        self.rise = rise
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sl1", type=float, default=730.)
    parser.add_argument("--sl2", type=float, default=2922.)
    parser.add_argument("--pause_length", type=float, default=183)
    ...
    fileroot = 'pause2_pl%i_' % pause_length
    file_end = 'v1.7_'
    ...
    run_sched(surveys, survey_length=None, verbose=verbose,
              ...
              nside=nside, illum_limit=illum_limit, sl1=sl1, sl2=sl2, pause_length=pause_length)
