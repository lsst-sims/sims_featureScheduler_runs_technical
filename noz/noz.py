...
def gen_greedy_surveys(nside=32, nexp=2, exptime=30., filters=['r', 'i', 'y'],
...
def generate_blobs(nside, nexp=2, exptime=30., filter1s=['u', 'u', 'g', 'r', 'i', 'y'],
                   filter2s=['g', 'r', 'r', 'i', 'y', 'y'], pair_time=22.,
